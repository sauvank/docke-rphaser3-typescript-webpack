...
| `npm start` | Launch browser of choice and navigate to [http://localhost:3000/](http://localhost:3000/). <br> Press `Ctrl + C` in NodeJS terminal to kill **webpack-dev-server** process. |
=======
